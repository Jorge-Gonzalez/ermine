...
export const PLAYBOOK_RECIPES: PlaybookRecipe[] = [
  ...
  {
    id: "user-content-molecule-boundary",
    title: "User-content/prose molecule boundary",
    kind: "boundary",
    confidence: "human",
    decision: "Rich-text defaults inside user-authored content should move as a molecule, not as scattered flat utility words.",
    before: ".content-editor-body h1 { margin: 0.75em 0 0.4em; }",
    after: "keep local until a prose/editor-content molecule is admitted",
    conversion: "Group descendant typography and rhythm as prose/editor-content evidence.",
