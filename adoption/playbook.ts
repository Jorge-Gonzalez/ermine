...
export const PLAYBOOK_RECIPES: PlaybookRecipe[] = [
  ...
  },
  {
    ...
    after: "delegate to a browser-adapter/post-processing layer",
    conversion: "Keep engine-specific pseudo selectors grouped by scrollbar part until a post-process adapter owns them.",
    boundary: "Ermine may own standard scrollbar tokens/sockets; browser-specific part selectors stay post-process owned.",
