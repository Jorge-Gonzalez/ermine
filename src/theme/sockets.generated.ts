...
export const SOCKET_FAMILIES = {
  color: ["ground", "ground-subtle", "ground-defined", "ground-hover", "ground-active", "ground-selected", "ink", "ink-soft", "ink-muted", "ink-faint", "ink-inverse", "ink-selected", "rule", "rule-soft", "accent", "accent-soft", "accent-faint", "pass", "pass-faint", "warn", "warn-faint", "fail", "fail-faint", "note", "note-faint"],
