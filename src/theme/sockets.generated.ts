...
export const SOCKET_FAMILIES = {
  color: ["ground", "ground-subtle", "ground-defined", "ink", "ink-soft", "ink-muted", "ink-faint", "ink-inverse", "rule", "rule-soft", "accent", "accent-soft", "accent-faint", "pass", "pass-faint", "warn", "warn-faint", "fail", "fail-faint", "note", "note-faint"],
