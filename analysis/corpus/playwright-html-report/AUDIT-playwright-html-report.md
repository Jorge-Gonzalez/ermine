...
Top uncovered families: height (11), white-space (10), cursor (10), outline (7), -webkit-user-select (7), user-select (7), text-overflow (6), fill (5), width (5), float (4), color-scheme (3), visibility (3).
