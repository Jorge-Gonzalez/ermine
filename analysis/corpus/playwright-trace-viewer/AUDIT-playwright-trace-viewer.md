...
|---|---|---|
| playwright-trace-viewer | 53.4% | 49.9% |

Declarations: 4199 total; 2103 real properties; 2096 theme custom properties.
Top uncovered families: content (576), height (44), cursor (39), top (36), width (35), line-height (35), -webkit-user-select (26), user-select (26), left (25), text-decoration (22), bottom (20), right (19).
