...
|---|---|---|
| playwright-recorder | 36.7% | 48.7% |

Declarations: 2157 total; 1107 real properties; 1050 theme custom properties.
Top uncovered families: content (573), height (15), cursor (12), top (11), bottom (11), width (10), left (9), right (9), visibility (7), text-decoration (6), color-scheme (3), -webkit-user-select (3).
