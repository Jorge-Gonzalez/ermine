...
|---|---|---|
| playwright-dashboard | 52.3% | 55.3% |

Declarations: 3462 total; 1546 real properties; 1916 theme custom properties.
Top uncovered families: content (573), height (38), width (30), right (15), bottom (12), pointer-events (9), line-height (7), box-sizing (6), -webkit-user-select (5), user-select (5), color-scheme (4), animation (4).
