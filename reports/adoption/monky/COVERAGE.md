...
- **Current assimilation:** the generated current ledger now reports **520 current
  declarations**, **364 adopted/infrastructure declarations**, **156 project-owned
...
The current generated ledger is at Monky `16d21d8`: 520 declarations, 364
adopted/infrastructure declarations, 156 project-owned residue declarations,
...
pass. The current ledger at Monky `16d21d8` reports 520
current declarations, 364 adopted/infrastructure declarations, 156 project-owned residue,
...
skin, and editor style-option state migrations moved the live ledger to
520 current declarations,
156 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
