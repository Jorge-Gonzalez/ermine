...
- **Current assimilation:** the generated current ledger now reports **517 current
  declarations**, **395 adopted/infrastructure declarations**, **122 project-owned
...
- **Adjusted word-assimilation target:** after excluding semantic fragments and the
  ...
  **34 declarations across 23 rules**; the excluded boundary material remains in the
  conserved 122-declaration ledger.
...
The current generated ledger is at Monky `aeb2cb9`: 517 declarations, 395
adopted/infrastructure declarations, 122 project-owned residue declarations,
...
pass. The current ledger at Monky `aeb2cb9` reports 517
current declarations, 395 adopted/infrastructure declarations, 122 project-owned residue,
...
`RULE-RESIDUE-ANALYSIS.md` re-reads the 122 current project-owned declarations at rule
granularity: they collapse to 59 authored CSS rules, mostly editor-content molecules,
private pseudo drawing, control-state recipes, and a small local identity floor. It also
reports the adjusted word-assimilation target: 34 declarations across 23 rules after
...
scrim backdrop, offset attachment, and positioned inset cleanup
moved the live
ledger to
517 current declarations,
122 project-owned residue,
34 declarations in the adjusted word-assimilation target,
`assimilable = 0`,
and `shadowed = 0`.
