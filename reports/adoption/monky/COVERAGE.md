...
- **Current assimilation:** the generated current ledger now reports **522 current
  declarations**, **368 adopted/infrastructure declarations**, **154 project-owned
...
The current generated ledger is at Monky `38ba893`: 522 declarations, 368
adopted/infrastructure declarations, 154 project-owned residue declarations,
...
pass. The current ledger at Monky `38ba893` reports 522
current declarations, 368 adopted/infrastructure declarations, 154 project-owned residue,
...
skin, editor style-option state, and pressed/expanded state-prefix migrations moved the live
ledger to
522 current declarations,
154 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
