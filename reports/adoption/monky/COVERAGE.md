...
- **Current assimilation:** the generated current ledger now reports **512 current
  declarations**, **270 adopted/infrastructure declarations**, **242 project-owned
...
The current generated ledger is at Monky `2713af3`: 512 declarations, 270
adopted/infrastructure declarations, 242 project-owned residue declarations,
...
pass. The current ledger at Monky `2713af3` reports 512
current declarations, 270 adopted/infrastructure declarations, 242 project-owned residue,
...
(`content`/`dropdown`), and block/inline spacing migrations moved the live ledger to
512 current declarations, 242 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
