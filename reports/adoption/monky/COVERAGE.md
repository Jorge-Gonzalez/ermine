...
- **Current assimilation:** the generated current ledger now reports **524 current
  declarations**, **381 adopted/infrastructure declarations**, **143 project-owned
...
The current generated ledger is at Monky `ab1864e`: 524 declarations, 381
adopted/infrastructure declarations, 143 project-owned residue declarations,
...
pass. The current ledger at Monky `ab1864e` reports 524
current declarations, 381 adopted/infrastructure declarations, 143 project-owned residue,
...
skin, editor style-option state, pressed/expanded state-prefix, and spacing-none endpoint
migrations moved the live
ledger to
524 current declarations,
143 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
