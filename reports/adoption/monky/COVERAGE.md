...
- **Current assimilation:** the generated current ledger now reports **520 current
  declarations**, **394 adopted/infrastructure declarations**, **126 project-owned
...
- **Adjusted word-assimilation target:** after excluding semantic fragments and the
  ...
  **38 declarations across 25 rules**; the excluded boundary material remains in the
  conserved 126-declaration ledger.
...
The current generated ledger is at Monky `6714b7a`: 520 declarations, 394
adopted/infrastructure declarations, 126 project-owned residue declarations,
...
pass. The current ledger at Monky `6714b7a` reports 520
current declarations, 394 adopted/infrastructure declarations, 126 project-owned residue,
...
`RULE-RESIDUE-ANALYSIS.md` re-reads the 126 current project-owned declarations at rule
...
reports the adjusted word-assimilation target: 38 declarations across 25 rules after
...
scrim backdrop, and offset attachment
moved the live
ledger to
520 current declarations,
126 project-owned residue,
38 declarations in the adjusted word-assimilation target,
`assimilable = 0`,
and `shadowed = 0`.
