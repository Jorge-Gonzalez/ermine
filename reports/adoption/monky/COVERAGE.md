...
- **Current assimilation:** the generated current ledger now reports **516 current
  declarations**, **306 adopted/infrastructure declarations**, **210 project-owned
...
The current generated ledger is at Monky `9634a3b`: 516 declarations, 306
adopted/infrastructure declarations, 210 project-owned residue declarations,
...
pass. The current ledger at Monky `9634a3b` reports 516
current declarations, 306 adopted/infrastructure declarations, 210 project-owned residue,
...
edge-attachment, and side-corner migrations moved the live ledger to 516 current declarations,
210 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
