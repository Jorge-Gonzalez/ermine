...
- **Current assimilation:** the generated current ledger now reports **513 current
  declarations**, **232 adopted/infrastructure declarations**, **281 project-owned
...
The current generated ledger is at Monky `8053670`: 513 declarations, 232
adopted/infrastructure declarations, 281 project-owned residue declarations,
...
Phase D's gate holds the list at zero. The current gate at Monky `8053670` reports 513
current declarations, 281 project-owned residue, `assimilable = 0`, and no shadowed words;
...
`hug-inline`, `center-x`, `center-y`, and size `2xl`/`max-width-2xl`. The remaining Phase 3 grammar work is the proportional/relational plane
(flow-center, remaining measure, viewport fill, grid fit, and columns + intent-proportions) plus the smaller
...
`center-y`, and size `2xl`/`max-width-2xl` migrations moved the live ledger to 513 current
declarations, 281 project-owned residue, `assimilable = 0`,
and `shadowed = 0`.
