...
- **Current assimilation:** the generated current ledger now reports **516 current
  declarations**, **226 adopted/infrastructure declarations**, **290 project-owned
...
The current generated ledger is at Monky `8231ef4`: 516 declarations, 226
adopted/infrastructure declarations, 290 project-owned residue declarations,
...
Phase D's gate holds the list at zero. The current gate at Monky `8231ef4` reports 516
current declarations, 290 project-owned residue, `assimilable = 0`, and no shadowed words;
...
and `hug-inline`. The remaining Phase 3 grammar work is the proportional/relational plane
(`center`, `measure`, viewport fill, grid fit, and columns + intent-proportions) plus the smaller
...
counts at that checkpoint; later `fill`, `square`, `cover`, `push`, and `hug-inline` migrations
moved the live ledger to 516 current declarations, 290 project-owned residue, `assimilable = 0`,
and `shadowed = 0`.
