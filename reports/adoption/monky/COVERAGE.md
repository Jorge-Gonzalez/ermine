...
- **Current assimilation:** the generated current ledger now reports **522 current
  declarations**, **363 adopted/infrastructure declarations**, **159 project-owned
...
The current generated ledger is at Monky `a94e7c8`: 522 declarations, 363
adopted/infrastructure declarations, 159 project-owned residue declarations,
...
pass. The current ledger at Monky `a94e7c8` reports 522
current declarations, 363 adopted/infrastructure declarations, 159 project-owned residue,
...
plus text-flow release (`text-wrap`/`overflow-visible`), rule edge-colour, and checked group
skin migrations moved the live ledger to
522 current declarations,
159 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
