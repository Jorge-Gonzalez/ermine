...
- **Current assimilation:** the generated current ledger now reports **523 current
  declarations**, **382 adopted/infrastructure declarations**, **141 project-owned
...
The current generated ledger is at Monky `e8aace8`: 523 declarations, 382
adopted/infrastructure declarations, 141 project-owned residue declarations,
...
pass. The current ledger at Monky `e8aace8` reports 523
current declarations, 382 adopted/infrastructure declarations, 141 project-owned residue,
...
and existing-scale modal-nav migrations moved the live
ledger to
523 current declarations,
141 project-owned residue,
`assimilable = 0`,
and `shadowed = 0`.
