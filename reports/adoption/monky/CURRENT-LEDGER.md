...
| adopted/infrastructure (generated grammar, substrate, theme metrics, config) | 228 |
| **residue — project-owned declarations** | **284** |
...
| code | count | meaning |
|---|---:|---|
| `ermine-emitted` | 141 | the generated Ermine grammar surface (adopted, not residue) |
