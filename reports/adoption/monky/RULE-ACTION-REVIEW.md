...
| metric | count |
| --- | --- |
| reviewed residue declarations | 170 |
| assimilable now | 0 |
| latent generalizable | 70 |
...
| motion-transition | 3 |
| reset-inheritance-neutralization | 12 |
...
| reset-inheritance-neutralization | latent-facet | 10 | add a missing facet on an existing Ermine concept |
