...
| Adoption conversion memory | [`docs/ADOPTION-PLAYBOOK.md`](ADOPTION-PLAYBOOK.md), [`docs/SEMANTIC-FRAGMENTS.md`](SEMANTIC-FRAGMENTS.md), and [`adoption/playbook.ts`](../adoption/playbook.ts) | Adoption reports, second-project onboarding |
